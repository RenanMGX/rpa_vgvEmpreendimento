...
class TratarDados:
    ...
    def __init__(self, *, paths:dict, incc_path:str, date:datetime=datetime.now()):
    ...
    def start(self) -> pd.DataFrame:
        df = self.df_empre[['Código Empreendimento', 'Nome Do Bloco', 'Código Da Unidade', 'Área Privativa']]
